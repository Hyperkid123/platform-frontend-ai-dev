...
class TestGetTask:
    ...
    def test_get_task_success(self, mock_http):
        ...
        mock_http.return_value = {
            "items": [
                {"external_key": "TEST-123", "external_key": "TEST-123", "pr_url": "https://github.com/org/repo/pull/1", "pr_number": 1},
                {"external_key": "TEST-456", "jira_key": "TEST-456", "pr_url": "https://github.com/org/repo/pull/2", "pr_number": 2},
            ]
        }
